...
/**
 * Log a dashboard activity (CRUD operation)
 * Uses LogsModel::LogError() internally with 'activity' status
 */
function logActivity($action, $resource, $details = '')
{
    try {
        ...
        \App\Models\LogsModel::LogError($message, 'activity');
    } catch (\Throwable $e) {
