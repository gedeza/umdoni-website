...
class Users extends \Core\Controller
{
    ...
    public function updateAction()
    {
        ...
        try 
        {
            ...
            logActivity('Updated', 'user', $data['username'] ?? $data['user_id'] ?? '');
        } catch (\Throwable $th) 
        {
            echo $th->getMessage();
        }
    ...
    public function saveAction()
    {
        ...
        try
        {
            ...
            logActivity('Created', 'user', $data['username'] ?? $data['email'] ?? '');
...
public function manageuserAction()
{
    ...
    try{
       ...
       logActivity('Changed status', 'user', "ID: " . ($data['user_id'] ?? ''));
       redirect('dashboard/users/index');
    ...
    public function manageroleAction()
    {
        ...
        try{
            ...
            logActivity('Changed role', 'user', "ID: " . ($data['user_id'] ?? ''));
            redirect('dashboard/users/index');
        }catch(\Throwable $th)
        {
            echo $th->getMessage();
