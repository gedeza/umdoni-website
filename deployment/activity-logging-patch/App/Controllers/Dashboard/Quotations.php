...
class Quotations extends \Core\Controller
{
    ...
    public function saveAction()
    {
        ...
        try {
            ...
            logActivity('Created', 'quotation', $data['title'] ?? '');
...
public function updateStatusAction()
{
    ...
    try {
        ...
        logActivity('Updated status', 'quotation', "ID: {$id} to {$status}");
...
public static function getStatusName($status)
{
    ...
    public function updateAction()
    {
        ...
        try 
        {
          ...
          logActivity('Updated', 'quotation', $data['title'] ?? $data['id'] ?? '');
    ...
    public function deleteAction()
    {
        ...
        try
        {
            ...
            logActivity('Deleted', 'quotation', "ID: {$id}");
        } catch (\Throwable $th)
        {
            echo $th->getMessage();
        }
    ...
    public function archiveExpiredAction()
    {
        try {
            ...
            if ($count > 0) {
                logActivity('Archived expired', 'quotations', "{$count} archived");
