...
class Councillors extends \Core\Controller
{
    ...
    public function saveAction()
    {
        ...
        try {
            ...
            if ($id) {
                logActivity('Created', 'councillor', $data['name'] ?? '');
    ...
    public function saveExcoAction()
    {
        ...
        try {
            ...
            if ($id) {
                logActivity('Created', 'exco member', $data['name'] ?? '');
    ...
    public function savemanAction()
    {
        ...
        try {
            ...
            if ($id) {
                logActivity('Created', 'senior manager', $data['name'] ?? '');
                $_SESSION['success'] =  ['message' => "Record created successfully"];
            }
        } catch (\Throwable $th) {
            $_SESSION['error'] = ['message' => $th->getMessage()];
    ...
    public function updateAction()
    {
        ...
        try {
            ...
            logActivity('Updated', 'councillor', $data['name'] ?? $data['id'] ?? '');
        } catch (\Throwable $th) {
            echo $th->getMessage();
        }
        redirect('dashboard/councillors/index');
    ...
    public function updateManAction()
    {
        ...
        try {
            ...
            logActivity('Updated', 'senior manager', $data['name'] ?? $data['id'] ?? '');
        } catch (\Throwable $th) {
            echo $th->getMessage();
        }
        redirect('dashboard/councillors/senior');
    ...
    public function updateExcoAction()
    {
        ...
        try {
            ...
            logActivity('Updated', 'exco member', $data['name'] ?? $data['id'] ?? '');
        } catch (\Throwable $th) {
            echo $th->getMessage();
        }
        redirect('dashboard/councillors/exco');
    ...
    public function deleteAction()
    {
        ...
        try {
            ...
            logActivity('Deleted', 'councillor', "ID: {$id}");
    ...
    public function deleteManAction()
    {
        ...
        try {
            ...
            logActivity('Deleted', 'senior manager', "ID: {$id}");
            $_SESSION['success'] =  ['message' => "Councillor successfully deleted"];
        } catch (\Throwable $th) {
            echo $th->getMessage();
            $_SESSION['error'] = ['message' => $th->getMessage()];
    ...
    public function deleteExcoAction()
    {
        ...
        try {
            ...
            logActivity('Deleted', 'exco member', "ID: {$id}");
            $_SESSION['success'] =  ['message' => "Councillor successfully deleted"];
        } catch (\Throwable $th) {
            echo $th->getMessage();
            $_SESSION['error'] = ['message' => $th->getMessage()];
