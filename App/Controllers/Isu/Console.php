...
class Console extends Guarded
{
    ...
    public function suspendAction()
    {
        ...
        if (SiteControl::suspend($this->actor(), $reason)) {
    ...
    public function restoreAction()
    {
        ...
        if (SiteControl::restore($this->actor(), $reason)) {
    ...
    /**
     * Normalise the logged-in ISU admin into the actor shape SiteControl
     * expects (it records user_id / actor name / email in the audit trail).
     */
    private function actor(): array
    {
        return [
            'user_id'  => $this->isuUser['id'] ?? null,
