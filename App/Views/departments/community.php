    ...
    <div class="row">
        ...
        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
            ...
            <p class="h1 text-uppercase fw-bold text-secondary">
                 General Manager : Mr B Ntsebeshe
            </p>

            <p class="fw-lighter fs-3 my-5">
                Most of the functions of this unit are routine repetitive operations which include maintenance
                 of the Municipal Parks & Gardens, establishment and maintenance of recreational facilities including Beaches. Maintenance of Community
                  Halls, overall management of Libraries as well as Public Safety through the Municipal Traffic and Policing Section and Fire & Disaster Management. 
            </p>
        </div>
    </div>
