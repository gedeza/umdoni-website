        ...
        <div class="row">
            <div class="col-md-12 d-flex justify-content-center">
                <div class="watermark rounded animate__animated animate__fadeInLeft">
                    ...
                    <p class=" text-white  text-wrap text-justify fw-lighter subtitle" style="font-size: 2em;">Umdoni Local Municipality is located in KwaZulu-Natal within the Ugu District Municipality (DC21). It consists of 19 wards and borders eThekwini Metro to the north and uMzumbe to the south, making it almost halfway between Port Shepstone and Durban.
                    </p>
                </div>
            </div>
        </div>
            ...
            <a href="<?php echo buildurl("services/request") ?>">
                <div class="card card-hover mb-3 card-border">
                    <div class="card-body">
                        ...
                        <p class="card-text text-secondary text-center small">Popular municipal services, like unwanted objects, graffiti.</p>
                    </div>
                </div>
            </a>
        </div>
            ...
            <a href="<?php echo buildurl("departments/index") ?>">
                <div class="card card-hover mb-3 card-border">
                    <div class="card-body">
                        ...
                        <p class="card-text text-secondary text-center small">Contacts for the municipal officials and departments.</p>
                    </div>
                </div>
            </a>
        </div>
        ...
        <div class="col-lg-3 col-md-3 col-sm-12">
            <div class="card card-hover mb-3 card-border">
                <div class="card-body">
                    ...
                    <p class="card-text text-secondary text-center small">Access municipal tenders and quotation requests.</p>
            ...
            <a href="<?php echo buildurl("services/meetings") ?>">
                <div class="card card-hover mb-3 card-border">
                    <div class="card-body">
                        ...
                        <p class="card-text text-secondary text-center small">Municipal council and commitee meetings and agendas.</p>
                    </div>
                </div>
            </a>
        </div>
            ...
            <a href="<?php echo buildurl("projects/index") ?>">
                <div class="card card-hover mb-3 card-border">
                    <div class="card-body">
                        ...
                        <p class="small p-1 text-secondary">Popular City Services like trash pickup & graffiti removal</p>
                    </div>
                </div>
            </a>
        </div>
            ...
            <a href="<?php echo buildurl("events/index") ?>">
                <div class="card card-hover mb-3 card-border">
                    <div class="card-body">
                        ...
                        <p class="small p-1 text-secondary">Contacts of the Municipal officials & departments</p>
                    </div>
                </div>
            </a>
        </div>
            ...
            <a href="<?php echo buildurl("notices/index") ?>">
                <div class="card card-hover mb-3 card-border">
                    <div class="card-body">
                        ...
                        <p class="small p-1 text-secondary">For notices, announcements and more</p>
                    </div>
                </div>
            </a>
        </div>
            ...
            <a href="<?php echo buildurl("documents/index") ?>">
                <div class="card card-hover mb-3 card-border">
                    <div class="card-body">
                        ...
                        <p class="small p-1 text-secondary">Access important documents related to Umdoni Municipality.</p>
                    </div>
                </div>
            </a>
        </div>
